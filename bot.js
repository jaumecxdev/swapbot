...
const WETH = new web3.eth.Contract(IERC20.abi, '0x533DD00C76346833A369aDEAd66431BacF96c0F5')
...
const main = async () => {
    ...
    console.log(`deployer: ${deployer}`)        // deployer: 0xD82396ED3d2f110a71D91c814BFeAd333d03C436
    console.log(`sniper: ${sniper}`)            // sniper: 0xb5f5Fe1bA4333c15C169CFFB96cA677a05d1eb36
